...
if(isset($configuration['features']['follow']['app'])) {
	foreach($configuration['features']['follow']['app'] as $app) {
...
if(isset($configuration['features']['follow']['pwa']) &&
	...
	$manifest->related_applications = [['platform' => 'webapp', 'url' => $protocol . $_SERVER['HTTP_HOST'] . '/' . $id->encode() . '/manifest.webmanifest']];
}
